...
int Update_BootImages(char *BootImagesPath);
void Update_Firmware_patch_info_File(char *FirmwareName,float Version,char *md5sum,char *);
void Update_Application_patch_info_File(char *ApplicationType,char *ApplicationName,float Version,char *md5sum,char *);
